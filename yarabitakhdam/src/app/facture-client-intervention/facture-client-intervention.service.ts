...
export class FactureClientInterventionService {
    ...
    getFactures (): Observable<Factures[]> {
        ...
        return this.http.get<Factures[]>(this.ApiUrl+'/indexIntervetion',{});
    ...
    UpdateLignesFacture (lignefacture: LigneFacture): Observable<LigneFacture> {

        return this.http.post<LigneFacture>(this.ApiUrl2+'/update', lignefacture).pipe(
            tap((lignefacture: LigneFacture) => this.log(` UpdateLignesFacture w/ id=${lignefacture.id}`)),
            catchError(this.handleError<LigneFacture>('UpdateLignesFacture'))
        );
    ...
    calculefacture (id:number):Observable<LigneFacture[]>{
        ...
        return this.http.get<LigneFacture[]>(this.ApiUrl2+'/calcule/'+id,{});
    }
